...
O programa apresenta um menu no terminal com as seguintes opções:
  ...
  2 - Completar matrícula parcial: Recebe uma matrícula com espaços em falta (ex: `41-__-BG`) e verifica se pode existir.
                                   Gera as combinaçãoes possíveis em Portugal e guarda os resultados num ficheiro ".txt" organizado alfabeticamente.
